...
<body style="background-color: #eaebef;">
	...
	<div style="text-align: center;margin:0;">
		<p>Vous avez demandé à réinitialiser votre mot de passe.</p><p>Veuillez confirmer votre demande en cliquant sur le lien suivant: <a href="http://localhost/P5/Blog/authentification/resetpassword?p=<?= $hashedlink ?>">Cliquez ici</a></p>
